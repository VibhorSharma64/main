...
video = cv2.VideoCapture('Samples\\footage.mp4') #give the path of the video you want to test

# video = cv2.VideoCapture(0) #give the path of the video you want to test
...
while True:
    ...
    frame = cv2.resize(frame, (1080, 720), fx = 0.1, fy = 0.1, interpolation = cv2.INTER_CUBIC)
